...
test -f "$work/root/usr/lib/systemd/user/draftside-companion-runtime.service"
test ! -e "$work/root/usr/lib/systemd/user/draftside-companion.service"
...
! grep -q '^PrivateTmp=' "$work/root/usr/lib/systemd/user/draftside-companion-runtime.service"
...
grep -q '<release version="0.4.7"' "$work/root/usr/share/metainfo/com.draftside.companion.metainfo.xml"
