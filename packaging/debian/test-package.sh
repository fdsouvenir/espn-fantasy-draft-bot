...
grep -q 'credential_source = "device"' "$work/root/usr/share/draftside-companion/config.example.toml"
! grep -q 'REPLACE_ME\|example.com' "$work/root/usr/share/draftside-companion/config.example.toml"
